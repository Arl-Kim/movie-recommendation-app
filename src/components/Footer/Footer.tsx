        ...
        <div className={styles.upperFooter}>
          <div className={styles.logoTextSocials}>
            ...
            <p className={styles.footerCtaText}>
              ...
              movies from around the world. Browse popular, top-rated, upcoming
              and now-playing movies all in one place.
            </p>
          ...
          <div className={styles.footerQuickLinks}>
            ...
            <Link to="/recommendations" className={styles.footerLink}>
              Explore
            </Link>
            <Link to="/recommendations" className={styles.footerLink}>
              Recommendations
